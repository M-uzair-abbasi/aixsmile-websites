...
export const EN = {
  ...
  s2: {
    ...
    figAlt: 'Fan of a dental shade guide with sample teeth from dark to light (AI-generated illustration)',
    figCap: 'Illustration of a shade guide. We measure in the mouth, in daylight; colours on screen are not binding.',
  ...
  bk: {
    ...
    existing: 'Have we met before?', addNote: '+ Add a note', note: 'Note (optional)',
